    ...
    <div className="">
      ...
      <div className="relative container mx-auto py-24 flex ">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className='lg:absolute  top-0 right-[-200px] static lg:order-none order-first'
          >
            <img src="/ailens/subscrition.png" className='2xl:w-[1000px] xl:w-[800px] lg:w-[500px]' alt="" />
          </div>
        </div>
      </div>
    </div>
