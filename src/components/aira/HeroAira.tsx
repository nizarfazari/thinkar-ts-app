    ...
    return (
        <section className="container mx-auto flex flex-col md:flex-row items-center justify-between relative h-auto md:h-[200px] px-6 md:px-20 py-12 md:py-0">
            ...
            >
                ...
                <h2 className="text-[#5F5F5F] text-center md:text-start text-3xl font-inter font-medium">
            ...
            <div className="w-full md:w-1/2 mt-8 md:mt-0 relative flex justify-center md:justify-end order-first md:order-none">
                <div
                    ...
                    className="max-w-[200px] sm:max-w-md md:max-w-lg lg:max-w-2xl translate-x-[0px] scale-[2] md:scale-[1.4] md:translate-x-[140px] md:-translate-y-[20px] -translate-y-[50px]  "
                >
                    <img
                        src="/aira/hero.png"
                        alt="Smart Glasses"
